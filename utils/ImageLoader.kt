//package com.example.asus.musicmanagementapp.utils
//
...
//    fun loadImage(context: Context, imageUrl: String, placeHolderResourceID: Int, imageView: ImageView, callbacks: ImageLoaderCallbacks?) {
//        val weakReference = WeakReference(context)
